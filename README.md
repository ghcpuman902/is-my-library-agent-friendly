...
```bash
npx skills add ghcpuman902/is-my-library-agent-friendly --skill audit
```
...
**audit.** Score the target. Start from inside the library under audit, load this skill, follow `skills/audit/SKILL.md`. Do not clone the target as a first step. Look around first.
